...
**_a) Start Containers with docker compose first_**
...
**_b) Check docker containers are running_**
...
**_a) Change to settings.py file in root project directory_**

```bash
cd shop_kipa_project/settings.py
```

**_b) At the ' DATABASES ' object configure:_**
...
(PS: You should have MySQL installed for this to work 😅)
...
## Here's a look at the Shop-kipa's UI:

Home page:

![Home Page](assets/shop_kipa3.png)

Login/Registration page:

![Login Page](assets/shop_kipa1.png)

Admin view (superuser):

![Admin View](assets/shop_kipa2.png)
...
4. 😄 **[Buy me coffee](https://github.com/sponsors/AustinMusuya)**
